...
extern "C"
{
  ...
  void Render(size_t width, size_t height, size_t samples, uchar4 *__cuda__pRenderBuffer, void *p__cuda__pOctreeData, uOctPtr_t *__cuda__pStreamerData, mat4x4 cameraMatrix);
